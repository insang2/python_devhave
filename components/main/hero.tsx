...
export default function AetherHero({
  ...
  return (
    <section
      className={`aurora-hero relative overflow-hidden w-full ${className}`}
      style={{ height }}
      aria-label="Hero"
    >
      ...
      {/* Content layer */}
      <div
        className="aurora-content relative z-10 h-full flex items-center p-[min(6vw,64px)]"
        style={{
      ...
      >
        ...
        >
          {children}
          <h1 className="m-0 text-[clamp(2.2rem,6vw,4.5rem)] leading-[1.04] tracking-tight font-bold drop-shadow-[0_6px_36px_rgba(0,0,0,0.45)]">
            {title}
          </h1>

          {subtitle ? (
            <p
              className="mt-4 text-[clamp(1rem,2vw,1.25rem)] leading-relaxed opacity-90 drop-shadow-[0_4px_24px_rgba(0,0,0,0.35)] max-w-[900px]"
          ...
          {(ctaLabel || secondaryCtaLabel) && (
            <div className="inline-flex gap-3 mt-8 flex-wrap">
              {ctaLabel ? (
                <a
                  href={ctaHref}
                  className="aurora-btn aurora-btn--primary px-[18px] py-[12px] rounded-xl font-semibold no-underline text-white bg-gradient-to-b from-[#ffffff2e] to-[#ffffff0f] shadow-[inset_0_0_0_1px_rgba(255,255,255,0.28),0_10px_30px_rgba(0,0,0,0.2)] backdrop-blur-md backdrop-saturate-125 transition-transform hover:scale-105 active:scale-95"
                >
                  {ctaLabel}
                </a>
              ) : null}
              ...
              {secondaryCtaLabel ? (
                <a
                  ...
                  className="aurora-btn aurora-btn--ghost px-[18px] py-[12px] rounded-xl font-semibold no-underline text-white bg-transparent opacity-85 shadow-[inset_0_0_0_1px_rgba(255,255,255,0.28)] backdrop-blur-sm transition-transform hover:scale-105 active:scale-95 hover:opacity-100"
                >
                  {secondaryCtaLabel}
                </a>
              ) : null}
